...
DATA_DIR = 'datasets/personal_attack/'
...
BIN_PROMPTS = {
    'personal_attack-a': 'Does this comment contain a personal attack?',
    'personal_attack-qa': 'Does this comment contain a  personal attack that is being quoted?',
    'personal_attack-ra': 'Does this comment contain  a personal attack targeted at recipient of the message?',
    'personal_attack-tpa': 'Does this comment contain a personal attack targeted at a third-party?',
}

BIN_LABEL_MAPPINGS = {
    'personal_attack-a': ["no","yes"],
    'personal_attack-qa': ["no","yes"],
    'personal_attack-ra': ["no","yes"],
    'personal_attack-tpa': ["no","yes"],
   }



class PersonalAttackDataset(LAMOLDataset):
