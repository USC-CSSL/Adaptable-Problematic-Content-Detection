...
DATA_DIR = 'datasets/GHC/'

# CHOICE_PROMPTS = {
#     'ghc-hd': "Does this text contain human degradation?",
#     'ghc-cv': "Does this text call for violence?",
#     'ghc-vo': "Does this text contain vulgarity?"
# }
