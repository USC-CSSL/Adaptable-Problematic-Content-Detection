...
adapter_vanilla=adapter_vanilla_third_set_${reg}_s64_d256_limit
BiHNet_vanilla=BiHNet_vanilla_third_set_${reg}_s64_d256_limit

BiHNet_ewc=BiHNet_ewc_third_set_${reg}_s64_d256_limit
BiHNet_reg=BiHNet_Reg_third_set_${reg}_s64_d256_limit
...
python run_model.py --do_few_shot_predict --output_dir runs/${adapter_vanilla}/${lr}/${seed} --max_input_length 100  \
...
# # BART-BiHNet+Reg
# python run_model.py --do_few_shot_predict --output_dir runs/${BiHNet_reg}/${lr}/${seed} --max_input_length 100  \
...
# BART-BiHNet-Vanilla
# python run_model.py --do_few_shot_predict --output_dir runs/${BiHNet_vanilla}/${lr}/${seed} --max_input_length 100  \
# --k_shot 16  --cl_method naive --hard_long_term --no_short_term \
# --eval_period 100000 --eval_at_epoch_end  --wait_step 3 --num_train_epochs 100 \
# --seed ${seed} --train_batch_size 64 --predict_batch_size 16 --few_shot_train_batch_size 16 \
# --few_shot_wait_step 100000 --few_shot_num_train_epochs ${few_shot_num_train_epochs} --wait_step 3 --gradient_accumulation_steps 4 \
...
# BART-BiHNet+EWC
# python run_model.py --do_few_shot_predict --output_dir runs/${BiHNet_ewc}/${lr}/${seed} --max_input_length 100  \
# --k_shot 16  --cl_method naive --hard_long_term --no_short_term \
# --eval_period 100000 --eval_at_epoch_end  --wait_step 3 --num_train_epochs 100 \
# --seed ${seed} --train_batch_size 64 --predict_batch_size 16 --few_shot_train_batch_size 16 \
# --few_shot_wait_step 100000 --few_shot_num_train_epochs ${few_shot_num_train_epochs} --wait_step 3 --gradient_accumulation_steps 4 \
